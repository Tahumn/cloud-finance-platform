...
export default function SettingsScreen({
  ...
  const updateUi = (key, value) => {
    ...
    if (userPrefMapping[key]) {
      const uPrefs = getUserPrefs(email);

      saveUserPrefs(email, {
        ...uPrefs,
        [userPrefMapping[key]]: value,
      });
    }
        ...
        <div className="stg-profile-left">
          ...
          <div className="stg-profile-info">
            ...
            <p className="join-date">
              Thông tin tài khoản lấy từ API đăng nhập.
            </p>
          </div>
        </div>
        <button className="stg-btn-outline" type="button">
          Chỉnh sửa hồ sơ
        </button>
      </div>
      ...
      <div className="stg-grid-3">
        ...
        <div className="stg-col">
          <div className="stg-card">
            ...
            <div
              className="stg-toggle-item"
              onClick={() =>
                updateSetting("thresholdAlerts", !settings.thresholdAlerts)
              }
            >
              <div className="stg-toggle-info">
        ...
        <div className="stg-col">
          <div className="stg-card">
            ...
            <span className="stg-layout-title" style={{ marginTop: "20px" }}>
              Chủ đề màu
            </span>
            <div className="stg-color-themes">
              ...
              <div
                className="stg-color-dot custom-picker"
                style={{ background: uiPrefs.brandColor }}
              >
                <svg
                  width="14"
                  height="14"
            ...
            <span className="stg-layout-title" style={{ marginTop: "24px" }}>
              Bố cục hiển thị
            </span>
