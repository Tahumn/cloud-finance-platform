...
import { applyUserPrefs, getUserPrefs } from "../../utils/userPrefs";
    ...
    try {
      ...
      for (const category of enabledCats) {
        try {
          ...
          throw new Error(`Không thể tạo danh mục "${category.name}".`);
        }
      }
      ...
      const prefs = {
        ...
        textColor: textColorMode === "custom" ? customTextColor : undefined,
      };

      saveUserPrefs(userEmail, prefs);

      const uiPrefs = {
        ...(currentUiPrefs || {}),

        theme,
        brandColor: finalPrimaryColor,
        templateId: layoutTemplate,
      };

      saveUiPrefs(userEmail, uiPrefs);

      localStorage.setItem(`uiPrefs:${userEmail}`, JSON.stringify(uiPrefs));
        ...
        <header className="ob-header">
          <div className="ob-header-top">
            ...
            <div className="ob-header-right">
              <span className="ob-progress-fraction">
                {step}/{totalSteps}
              </span>
            </div>
          </div>
          ...
          <div className="ob-progress-container">
            <div className="ob-progress-track">
              ...
              {[1, 2, 3, 4].map((s) => (
                <div
                  key={s}
                  className={`ob-progress-dot ${s <= step ? "active" : ""}`}
                  style={{ left: `${((s - 1) / (totalSteps - 1)) * 100}%` }}
                ></div>
              ))}
            </div>
          </div>
          ...
          <p className="ob-subtitle">
            {step === 1 &&
              "Hoàn tất các thông tin cơ bản để khởi tạo tài khoản của bạn."}
            {step === 2 &&
              "Chọn các danh mục bạn thường sử dụng. Bạn có thể thay đổi hoặc thêm mới sau này."}
            {step === 3 &&
              "Tùy chỉnh ngôn ngữ và giao diện để phù hợp với thói quen sử dụng của bạn."}
            {step === 4 &&
              "Vui lòng xem lại các thiết lập của bạn trước khi bắt đầu."}
          </p>
        </header>
              ...
              <div className="ob-form-col">
                <div className="ob-section-title">
                  ...
                  <div>
                    ...
                    <p>
                      Lưu tài khoản hoặc thẻ đầu tiên của bạn và số dư mở đầu để
                ...
                <div className="ob-field">
                  ...
                  <input
                    ...
                    placeholder="Ví dụ: Tài khoản lương, Techcombank, Thẻ Visa..."
                  />
                </div>
                ...
                <div className="ob-field">
                  ...
                  <div className="ob-type-group">
                    ...
                    <button
                      type="button"
                      className={accType === "wallet" ? "active" : ""}
                      onClick={() => {
                        setAccType("wallet");
                        setAccProvider("");
                      }}
                    ...
                    <button
                      type="button"
                      className={accType === "credit" ? "active" : ""}
                      onClick={() => {
                        setAccType("credit");
                        setAccProvider("");
                      }}
                ...
                <div className="ob-row">
                  {accType !== "cash" && (
                    <div className="ob-field">
                      ...
                      <input
                        ...
                        value={accLast4}
                        onChange={(e) =>
                          setAccLast4(e.target.value.replace(/\D/g, ""))
                        }
                  ...
                  <div className="ob-field">
                    ...
                    <input
                      ...
                      value={accBalance}
                      onChange={(e) =>
                        setAccBalance(formatNumberInput(e.target.value))
                      }
                ...
                {accType !== "cash" && (
                  <div className="ob-field">
                    ...
                    <input
                      ...
                      value={accLimit}
                      onChange={(e) =>
                        setAccLimit(formatNumberInput(e.target.value))
                      }
                ...
                <div className="ob-preview-mini">
                  ...
                  <div className="acc-mini-card">
                    ...
                    <div className="acc-mini-main">
                      <strong>
                        {accName ||
                          (accType === "cash" ? "Tiền mặt" : "Tài khoản mới")}
                      </strong>
                ...
                <div className="ob-info-note">
                  ...
                  <span>
                    Số dư ban đầu sẽ được lưu cho tài khoản/thẻ này và được dùng
                    khi tạo giao dịch.
                  </span>
                </div>
              </div>
                          ...
                          <div className="ob-icon-picker">
                            {[
                              ...
                              <svg
                                ...
                                strokeWidth="2"
                              >
                                <path d="M4.5 16.5c-1.5 1.26-2 2.6-2 3.5 0 1 1 1 1 1h17s1 0 1-1c0-.9-.5-2.24-2-3.5" />
                                <path d="M15 14.5s-1.5 2-3 2-3-2-3-2V3c0-1 1-1 1-1h4s1 0 1 1v11.5z" />
                              </svg>,
                              <svg
                                width="20"
                                height="20"
                                ...
                                strokeWidth="2"
                              >
                                <path d="M22 10v6M2 10v6M22 12a10 10 0 0 1-20 0 10 10 0 0 1 20 0z" />
                              ...
                              >
                                <circle cx="12" cy="12" r="10" />
                                <path d="M6.7 6.7l10.6 10.6M6.7 17.3l10.6-10.6" />
                              </svg>,
                              <svg
                                width="20"
                                height="20"
                              ...
                              >
                                ...
                                <rect x="14" y="11" width="8" height="2" />
                              </svg>,
                              <svg
                                width="20"
                                height="20"
            ...
            <div className="ob-step ob-step-3">
              <div className="ob-section-title">
                ...
                <div>
                  ...
                  <p>
                    Tùy chỉnh ngôn ngữ và giao diện để phù hợp với thói quen sử
                    dụng của bạn.
                  </p>
                </div>
              </div>
              ...
              <div className="ob-settings-list">
                {/* Ngôn ngữ */}
                <div
                  className={`ob-setting-item ${activeDropdown === "language" ? "open" : ""}`}
                  onClick={(e) => {
                    e.stopPropagation();
                    setActiveDropdown(
                ...
                >
                  ...
                  {activeDropdown === "language" && (
                    <div className="ob-dropdown-menu">
                      <div
                        className={`ob-dropdown-option ${language === "vi" ? "active" : ""}`}
                        onClick={(e) => {
                          e.stopPropagation();
                          setLanguage("vi");
                          setActiveDropdown(null);
                      ...
                      <div
                        className={`ob-dropdown-option ${language === "en" ? "active" : ""}`}
                        onClick={(e) => {
                          e.stopPropagation();
                          setLanguage("en");
                          setActiveDropdown(null);
                ...
                {/* Chế độ màu */}
                <div
                  className={`ob-setting-item ${activeDropdown === "theme" ? "open" : ""}`}
                  onClick={(e) => {
                    e.stopPropagation();
                    setActiveDropdown(
                ...
                >
                  ...
                  {activeDropdown === "theme" && (
                    <div className="ob-dropdown-menu">
                      <div
                        className={`ob-dropdown-option ${theme === "light" ? "active" : ""}`}
                        onClick={(e) => {
                          e.stopPropagation();
                          setTheme("light");
                          setActiveDropdown(null);
                      ...
                      <div
                        className={`ob-dropdown-option ${theme === "dark" ? "active" : ""}`}
                        onClick={(e) => {
                          e.stopPropagation();
                          setTheme("dark");
                          setActiveDropdown(null);
                ...
                >
                  <div className="osi-left">
                    <svg
                      ...
                      strokeWidth="2"
                    >
                      <path d="m19 11-8-8-7 7 1 1h3v10h10V11h3Z" />
                      <path d="m5 8 7-7 7 7" />
                    </svg>
                  </div>
                ...
                {/* C cỡ chữ */}
                <div
                  className={`ob-setting-item ${activeDropdown === "font" ? "open" : ""}`}
                  onClick={(e) => {
                    e.stopPropagation();
                    setActiveDropdown(
                      activeDropdown === "font" ? null : "font",
                    );
                  }}
                >
                  <div className="osi-left">
                  ...
                  {activeDropdown === "font" && (
                    <div className="ob-dropdown-menu">
                      <div
                        className={`ob-dropdown-option ${fontScale === "small" ? "active" : ""}`}
                        onClick={() => setFontScale("small")}
                      >
                        Nhỏ
                      </div>
                      <div
                        className={`ob-dropdown-option ${fontScale === "medium" ? "active" : ""}`}
                        onClick={() => setFontScale("medium")}
                      >
                        Trung bình
                      </div>
                      <div
                        className={`ob-dropdown-option ${fontScale === "large" ? "active" : ""}`}
                ...
                <div
                  className={`ob-setting-item ${activeDropdown === "text" ? "open" : ""}`}
                  onClick={(e) => {
                    e.stopPropagation();
                    setActiveDropdown(
                      activeDropdown === "text" ? null : "text",
                    );
                  }}
                >
                  <div className="osi-left">
                  ...
                  {activeDropdown === "text" && (
                    <div className="ob-dropdown-menu">
                      <div
                        className={`ob-dropdown-option ${textColorMode === "auto" ? "active" : ""}`}
                        onClick={() => setTextColorMode("auto")}
                      >
                        Tự động (Tối)
                      </div>
                      <div
                        className={`ob-dropdown-option ${textColorMode === "dark" ? "active" : ""}`}
                        onClick={() => setTextColorMode("dark")}
                      >
                        Đen
                      </div>
                      <div
                        className={`ob-dropdown-option ${textColorMode === "gray" ? "active" : ""}`}
                        onClick={() => setTextColorMode("gray")}
                      >
                        Xanh dương
                      </div>
                    </div>
                      ...
                      <div className="mock-card">
                        ...
                        <div className="mock-chart">
                          <svg viewBox="0 0 200 60">
                            <path
                              d="M0 50 Q 50 20, 100 40 T 200 10"
                              stroke={primaryColor}
                              fill="none"
                              strokeWidth="2"
                            />
          ...
          {step === 4 && (
            <div className="ob-step ob-step-4">
              ...
              <div className="ob-confirm-list">
                ...
                <div className="ob-confirm-card">
                  ...
                  <div className="occ-main">
                    ...
                    <strong>
                      {categories.filter((c) => c.enabled).length} danh mục
                    </strong>
                  </div>
                </div>
                ...
                <div className="ob-confirm-card">
                  ...
                  >
                    ...
                    >
                      <circle cx="12" cy="12" r="10" />
                      <path d="M12 2v2M12 20v2M4.93 4.93 1.41 1.41M17.66 17.66 1.41 1.41M2 12h2M20 12h2M6.34 17.66-1.41 1.41M19.07 4.93-1.41 1.41" />
                    </svg>
                  </div>
                  <div className="occ-main">
                    <span>Chế độ màu</span>
                    <strong>
                      {theme === "light" ? "Sáng (Light)" : "Tối (Dark)"}
                    </strong>
                  </div>
                </div>
              </div>
              ...
              <div className="ob-security-card">
                ...
                <p>
                  Finanzy cam kết bảo mật thông tin và an toàn dữ liệu của bạn.
                </p>
              </div>
            </div>
          )}
